...
commentaire=lookup_widget(objet,"commentaire");
...
if (strcmp(u.cin_user,"-1")==0){
	gtk_widget_show(commentaire);}
else{
	gtk_widget_hide(commentaire);
	afficher_user(treeview,"search.txt");}
}
...
/*void
on_refresh_user_activate               (GtkButton       *button,
                                       gpointer         user_data)
{
...
void
on_refresh_user_clicked                (GtkButton       *button,
                                        gpointer         user_data)
{
